  ...
  return (
    ...
    >
      {cards.map((card, index) => {
        ...
        return (
          <motion.div key={index} variants={item} className="flex items-center p-6 bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow dark:bg-gray-800 dark:border-gray-700">
